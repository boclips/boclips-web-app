  ...
  return (
    <>
      <nav
        className={c(
          s.navbarResponsive,
          'grid col-span-full grid-rows-navbar-responsive items-center gap-x-2 lg:gap-x-4 grid-cols-responsive',
        )}
      ...
      >
        ...
        <div className="row-start-2 row-end-2 col-start-2 col-end-26 pb-3 pt-2 lg:pb-0 lg:pt-0 lg:row-start-1 lg:row-end-1 lg:col-start-6 lg:col-end-20">
