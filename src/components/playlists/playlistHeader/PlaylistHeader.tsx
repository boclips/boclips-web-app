...
import { PlaylistShareButton } from '@components/playlists/playlistHeader/shareButton/PlaylistShareButton';
import c from 'classnames';
import { Collection } from 'boclips-api-client/dist/sub-clients/collections/model/Collection';
import PlaylistDescription from '@components/playlists/PlaylistDescription';
import { Typography } from 'boclips-ui';
import PlaylistNavigation from '@components/playlists/PlaylistNavigation';
import PlaylistLastUpdatedBadge from '@components/playlists/playlistHeader/PlaylistLastUpdatedBadge';
import PlaylistOwnerBadge from '@components/playlists/playlistHeader/PlaylistOwnerBadge';
import { FeatureGate } from '@components/common/FeatureGate';
import { Product } from 'boclips-api-client/dist/sub-clients/accounts/model/Account';
import { PlaylistShareLinkButton } from '@components/shareLinkButton/PlaylistShareLinkButton';
