...
import LearningOutcomesAiMetadata from '@components/videoPage/videoMetadata/ai/LearningOutcomesAiMetadata';
import AssessmentQuestionsAiMetadata from '@components/videoPage/videoMetadata/ai/AssessmentQuestionsAiMetadata';
